...
#define AuroraChannel       atoi(argv[2])
#define AuroraDirection     argv[3]
/****************************************************************************************************************************
...
int main( int argc, char* argv[] )
{
	...
	************************************************************************************************************************/
	if (argc != 4)
	{
		printf( "Error: Wrong number of parameters\n"
			   ...
			   "Parameter 2 must be the Aurora channel, ex.: 0,\n"
			   "Parameter 3 must be the Aurora direction, ex.: {RX, TX, BOTH},\n"
	...
	/************************************************************************************************************************
												  Getting string parameter
	************************************************************************************************************************/
	res = GetStringParameter(AuroraDirection, &u32AuroraDirection);
	if(FAILURE(res))
	{
		printf("Error with GetStringParameters\n");
		Terminate(res);
		return res;
    }
	...
	************************************************************************************************************************/
	res = AuroraInitChannel(&state, AuroraChannel, u32AuroraDirection);
	if(FAILURE(res))
	{
		printf("\nError with AuroraInitChannel\n");
		Terminate(res);
		return res;
	}
