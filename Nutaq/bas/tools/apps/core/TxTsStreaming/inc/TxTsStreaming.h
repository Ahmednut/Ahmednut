...
#ifndef __TxTsStreaming__
#define __TxTsStreaming__
...
* @file TxTsStreaming.h
*****************************************************************************
* RTDExTimestamping Tx streaming functions
*
****************************************************************************/

/**
*****************************************************************************
* Function: TxTsStreaming
*****************************************************************************
*
* Performs TxTimestamping streaming (Host to FPGA). This function is blocking.
*
* @param [in]  pcIpAddresses
*      Array of IP addresses of the carriers to which data is to be streamed
*
* @param [in]  NbIpAddresses
*      Number of IP addresses pcIpAddresses holds
*
* @param [in]  handle_txstreaming
*      Pointer to a sRTDExTsStreamingParams object, holding parameters common to all
*      RTDExTimestamping channels to be used
*
* @param [in]  handle_txchannel
