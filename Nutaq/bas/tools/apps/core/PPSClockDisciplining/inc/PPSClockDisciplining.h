...
#ifndef __PPSClockDisciplining__
#define __PPSClockDisciplining__

/**
*****************************************************************************
* @file PPSClockDisciplining.h
*****************************************************************************
Functions to discipline the user clock using a PPS signal
****************************************************************************/


/**
*****************************************************************************
* Function: PPSClockDisciplining
*****************************************************************************
*
* Configures the PPS core to discipline the user clock using a PPS signal
*
* @param [in]  state
*      Pointer to the connection state structure that handles 
*      the TCP connection between the host and the carrier platform.
*
* @param [in]  uClockFrequency
*      Clock target frequency
*
* @param [in]  uPpsFrequency
*      Input PPS rising-edge event frequency
*
* @return
