 ...
 *
 * @file       perseus601x.h
 * @brief      Perseus601x carrier related functions definitions.
 *
...
#ifndef __PERSEUS601X_H__
#define __PERSEUS601X_H__
...
/** @defgroup PERSEUS601X Perseus601X FMC carrier related library
 *
 *  Allows to control and access information specific to the Perseus601X
 *  carrier board.
 *
 *  @file
 *
...
/****************************************************************************
 * Function: Perseus601X_Open
 ************************************************************************//**
 *
 * Open an instance of the Perseus601X carrier object. Must be on a
 * Perseus601X carrier board in order for this function to make sense.
 *
 * @param [out] phCarrier
...
/****************************************************************************
 * Function: Perseus601X_Close
 ************************************************************************//**
 *
 * Deallocate the Perseus601X carrier object.
 *
 * @param [in] hCarrier
...
Result Perseus601X_Close(Carrier_handle_t hCarrier);
 ...
 /****************************************************************************
 *   Function: Perseus601X_FmcGetI2cZone
 ************************************************************************//**
 *
...
/****************************************************************************
 * Function: Perseus601X_FmcAssignSlot
 ************************************************************************//**
 *
 * This function assign to each connector of the Perseus601x carrier, the detected fmc
 * modules.
 *
 * @param [in] hCarrier
 *    Handle to the carrier object previously open
 *
 * @param [in] connector
 *    Connector number used (perseus 601x has only 1 connector)
 *
 * @return
 *    Error code: #CARRIER_OK if no problem is found, !=#CARRIER_OK if problem.
 *    Use SUCCESS(ret) macro to detect if an error occured.
...
/****************************************************************************
 * Function: Perseus601X_FmcSetVadj
 ************************************************************************//**
 *
 ...
 *
 * @param [in] connector
 *    Connector number used (Perseus601x has only 1 connector)
 *
 * @param [in] board
...
/****************************************************************************
 * Function: Perseus601X_FmcGetVadj
 ************************************************************************//**
 *
...
/****************************************************************************
 * Function: Perseus601X_GetSignalsInfo
 ************************************************************************//**
 *
...
Result Perseus601X_GetSignalsInfo(Carrier_handle_t hCarrier, Carrier_eFmcConnectorNum_t connector, FMCEEPROM_HPC_DATA_Specs **ppSignal);
 ...
 /****************************************************************************
 *   Function: Perseus601X_GetModuleBaseAddr
 ************************************************************************//**
 *
...
Result Perseus601X_GetModuleBaseAddr(Carrier_handle_t hCarrier, Carrier_eModule_t module, unsigned int index, unsigned int * addr);
 ...
 /****************************************************************************
 *   Function: Perseus601X_GetModuleSize
 ************************************************************************//**
 *
...
Result Perseus601X_GetModuleSize(Carrier_handle_t hCarrier, Carrier_eModule_t module, unsigned int * size);
 ...
 /****************************************************************************
 *   Function: Perseus601X_GetModuleMaxNumber
 ************************************************************************//**
 *
...
Result Perseus601X_GetModuleMaxNumber(Carrier_handle_t hCarrier, Carrier_eModule_t module, unsigned int * num);
 ...
 /****************************************************************************
 *   Function: Perseus601X_GetMemSpaceBaseAddr
 ************************************************************************//**
 *
...
Result Perseus601X_GetMemSpaceBaseAddr(Carrier_handle_t hCarrier, Carrier_eMemSpace_t space, unsigned int * addr);
 ...
 /****************************************************************************
 *   Function: Perseus601X_GetMemSpaceSize
 ************************************************************************//**
 *
...
Result Perseus601X_GetMemSpaceSize(Carrier_handle_t hCarrier, Carrier_eMemSpace_t space, unsigned int * size);
 ...
 /****************************************************************************
 *   Function: Perseus601X_CustomRegisterWrite
 ************************************************************************//**
 *
...
Result Perseus601X_CustomRegisterWrite(Carrier_handle_t hCarrier, unsigned int index, unsigned int value);
 ...
 /****************************************************************************
 *   Function: Perseus601X_CustomRegisterRead
 ************************************************************************//**
 *
...
Result Perseus601X_CustomRegisterRead(Carrier_handle_t hCarrier, unsigned int index, unsigned int * value);
 ...
 /****************************************************************************
 *   Function: Perseus601X_LedSetValue
 ************************************************************************//**
 *
...
Result Perseus601X_LedSetValue(Carrier_handle_t hCarrier, unsigned int index, unsigned int value);
 ...
 /****************************************************************************
 *   Function: Perseus601X_LedGetValue
 ************************************************************************//**
 *
