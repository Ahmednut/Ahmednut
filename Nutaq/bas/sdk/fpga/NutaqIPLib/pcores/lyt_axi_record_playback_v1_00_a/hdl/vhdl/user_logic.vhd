...
--   1:0 RecTrigMux R W O=ov2_RecTrigMux_p
--   31:2 rsvd R
...
--   1:0 PlayTrigMux R W O=ov2_PlayTrigMux_p
--   31:2 rsvd R
    ...
    --if (Bus2IP_Resetn = '0') then
      ...
      case slv_reg_write_sel is
        ...
        when OneHotVector(26,36) =>
          if (Bus2IP_BE(0) = '1') then
            v2_RecTrigMux_s <= Bus2IP_Data(1 downto 0);
          end if;
        ...
        when OneHotVector(29,36) =>
          if (Bus2IP_BE(0) = '1') then
            v2_PlayTrigMux_s <= Bus2IP_Data(1 downto 0);
          end if;
 ...
 begin
   case slv_reg_read_sel is
        ...
        when OneHotVector(26,C_NUM_REG) =>
          slv_ip2bus_data(1 downto 0) <= v2_RecTrigMux_s;
        ...
        when OneHotVector(29,C_NUM_REG) =>
          slv_ip2bus_data(1 downto 0) <= v2_PlayTrigMux_s;
          slv_ip2bus_data(31 downto 2) <= "000000000000000000000000000000";
