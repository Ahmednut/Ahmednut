...
--   12:11 uart_mode R W O=ov2_uart_mode_p
...
-- BASEADDR + 0x8   CLK_CTRL    Lock Signals for the bustest and clocks status
...
-- BASEADDR + 0xbc   PPS_SYNC_PPSCNT    pps count register
--   31:0 PPSSYNC_PpsCnt R I=iv32_PPSSYNC_PpsCnt_p

-- BASEADDR + 0xc0   PPS_SYNC_DIFFACC    difference accumulator
--   31:0 PPSSYNC_DiffAcc R+ I=iv32_PPSSYNC_DiffAcc_p

-- BASEADDR + 0xc4   PPS_SYNC_PROGDELAY    programmable delay for moving window
--   31:0 PPSSYNC_ProgDelay R W O=ov32_PPSSYNC_ProgDelay_p

-- BASEADDR + 0xc8   PPS_SYNC_PPS_FREQ    PPS rising-edge frequency
--   31:0 PPSSYNC_PpsFreq R W O=ov32_PPSSYNC_PpsFreq_p

-- BASEADDR + 0xcc   LVDS0_COREID    LVDS instance 0 core ID
--   31:0 lvds0_coreid R I=iv32_lvds0_coreid_p

-- BASEADDR + 0xd0   LVDS0_CTRL    LVDS instance 0 control
--   31:0 lvds0_ctrl R W O=ov32_lvds0_ctrl_p

-- BASEADDR + 0xd4   LVDS0_VALUE    LVDS instance 0 value
--   31:0 lvds0_value R W I=iv32_lvds0_value_p O=ov32_lvds0_value_p

-- BASEADDR + 0xd8   LVDS0_OE    LVDS instance 0 output enable
--   31:0 lvds0_oe R W O=ov32_lvds0_oe_p

-- BASEADDR + 0xdc   LVDS1_COREID    LVDS instance 1 core ID
--   31:0 lvds1_coreid R I=iv32_lvds1_coreid_p

-- BASEADDR + 0xe0   LVDS1_CTRL    LVDS instance 1 control
--   31:0 lvds1_ctrl R W O=ov32_lvds1_ctrl_p

-- BASEADDR + 0xe4   LVDS1_VALUE    LVDS instance 1 value
--   31:0 lvds1_value R W I=iv32_lvds1_value_p O=ov32_lvds1_value_p

-- BASEADDR + 0xe8   LVDS1_OE    LVDS instance 1 output enable
--   31:0 lvds1_oe R W O=ov32_lvds1_oe_p

-- BASEADDR + 0xec   LVDS2_COREID    LVDS instance 2 core ID
--   31:0 lvds2_coreid R I=iv32_lvds2_coreid_p

-- BASEADDR + 0xf0   LVDS2_CTRL    LVDS instance 2 control
--   31:0 lvds2_ctrl R W O=ov32_lvds2_ctrl_p

-- BASEADDR + 0xf4   LVDS2_VALUE    LVDS instance 2 value
--   31:0 lvds2_value R W I=iv32_lvds2_value_p O=ov32_lvds2_value_p

-- BASEADDR + 0xf8   LVDS2_OE    LVDS instance 2 output enable
--   31:0 lvds2_oe R W O=ov32_lvds2_oe_p

-- BASEADDR + 0xfc   LVDS3_COREID    LVDS instance 3 core ID
--   31:0 lvds3_coreid R I=iv32_lvds3_coreid_p

-- BASEADDR + 0x100   LVDS3_CTRL    LVDS instance 3 control
--   31:0 lvds3_ctrl R W O=ov32_lvds3_ctrl_p

-- BASEADDR + 0x104   LVDS3_VALUE    LVDS instance 3 value
--   31:0 lvds3_value R W I=iv32_lvds3_value_p O=ov32_lvds3_value_p

-- BASEADDR + 0x108   LVDS3_OE    LVDS instance 3 output enable
--   31:0 lvds3_oe R W O=ov32_lvds3_oe_p

-- BASEADDR + 0x10c   RTDEX_SYNC_COREID   
--   31:0 RTDExSyncCoreId R I=iv32_RTDExSyncCoreId_p

-- BASEADDR + 0x110   RTDEX_SYNC_CTRL   
...
-- BASEADDR + 0x114   RTDEX_SYNC_WR_REG   
--   31:0 RtdexSyncWrReg R W O=ov32_RtdexSyncWrReg_p

-- BASEADDR + 0x118   RTDEX_SYNC_RD_REG   
--   31:0 RtdexSyncRdReg R I=iv32_RtdexSyncRdReg_p

-- BASEADDR + 0x11c   TIMESTAMP_COREID    timestamp core id and version
--   31:0 Timestamp_CoreIdVers R I=iv32_Timestamp_CoreIdVers_p

-- BASEADDR + 0x120   TIMESTAMP_CTRL    timestamp control register
...
-- BASEADDR + 0x124   TIMESTAMP_MSW    timestamp register MSW
--   31:0 Timestamp_MSW R W I=iv32_Timestamp_MSW_p O=ov32_Timestamp_MSW_p

-- BASEADDR + 0x128   TIMESTAMP_LSW    timestamp register LSW
...
-------------------------------------------------------------------------------
  ...
  signal v2_uart_mode_s                     : std_logic_vector(1 downto 0);
  ...
  signal slv_reg_write_sel              : std_logic_vector(74 downto 0);
  signal slv_reg_read_sel               : std_logic_vector(74 downto 0);
 ...
 begin
  ...
  Timestamp_LatchTime_s <= '0';
      case slv_reg_write_sel is
        ...
        when OneHotVector(1,75) =>
          if (Bus2IP_BE(1) = '1') then
            pcie_msi_s <= Bus2IP_Data(10);
          end if;
          if (Bus2IP_BE(1) = '1') then
            v2_uart_mode_s <= Bus2IP_Data(12 downto 11);
          end if;

        when OneHotVector(2,75) =>
        ...
        when OneHotVector(5,75) =>
          if (Bus2IP_BE(0) = '1') then
            MmcI2cReleaseReq_s <= Bus2IP_Data(0);
          end if;

        when OneHotVector(6,75) =>
          if (Bus2IP_BE(0) = '1') then
...
ov2_uart_mode_p <= v2_uart_mode_s;
