...
proc generate_corelevel_ucf {mhsinst} {
   ...
   puts $outputFileUcf "NET \"${name_lower}/CoreReset_s\" TIG;"
   puts $outputFileUcf "NET \"${name_lower}/USER_LOGIC_I/USER_LOGIC_I/v8_TxFifoReset_s*\" TIG;"
   puts $outputFileUcf "NET \"${name_lower}/USER_LOGIC_I/USER_LOGIC_I/v8_RxFifoReset_s*\" TIG;"
