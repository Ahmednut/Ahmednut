 ...
 *
 ****************************************************************************/
#ifndef ADP_SEMAPHORE_H__
#define ADP_SEMAPHORE_H__
...
#ifdef __linux__
typedef sem_t adp_semaphore_t;

#else //Windows
typedef HANDLE adp_semaphore_t;
