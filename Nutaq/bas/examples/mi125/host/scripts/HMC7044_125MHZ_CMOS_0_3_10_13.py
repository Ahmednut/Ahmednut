...
# glbl_cfg5_ibuf0_mode[4:1] = 0x8
dut.write(0xA, 0x11)

# glbl_cfg5_ibuf1_en[0:0] = 0x1
# glbl_cfg5_ibuf1_mode[4:1] = 0x8
dut.write(0xB, 0x11)

# glbl_cfg5_ibuf2_en[0:0] = 0x1
# glbl_cfg5_ibuf2_mode[4:1] = 0xA
dut.write(0xC, 0x15)

# glbl_cfg5_ibuf3_en[0:0] = 0x1
# glbl_cfg5_ibuf3_mode[4:1] = 0x8
dut.write(0xD, 0x11)

# glbl_cfg5_ibufv_en[0:0] = 0x1
# glbl_cfg5_ibufv_mode[4:1] = 0x8
dut.write(0xE, 0x11)
...
# pll1_cfg8_los_div_setpt_vcxo[7:0] = 0xC
dut.write(0x20, 0xC)

# pll1_cfg16_refdivrat_lsb[7:0] = 0x7D
dut.write(0x21, 0x7D)

# pll1_cfg16_refdivrat_msb[7:0] = 0x0
dut.write(0x22, 0x0)

# pll1_cfg16_fbdivrat_lsb[7:0] = 0x0
dut.write(0x26, 0x0)

# pll1_cfg16_fbdivrat_msb[7:0] = 0x6
dut.write(0x27, 0x6)
...
# pll2_rdiv_cfg12_divratio_lsb[7:0] = 0x80
dut.write(0x33, 0x80)

# pll2_rdiv_cfg12_divratio_msb[3:0] = 0x0
dut.write(0x34, 0x0)

# pll2_vdiv_cfg16_divratio_lsb[7:0] = 0x35
dut.write(0x35, 0x35)

# pll2_vdiv_cfg16_divratio_msb[3:0] = 0xC
dut.write(0x36, 0xC)
...
# sysr_cfg16_divrat_lsb[7:0] = 0x2C
dut.write(0x5C, 0x2C)
...
# alrm_ro4_pll1_los4_now[3:0] = 0xE
# alrm_ro1_pll1_hold_now[4:4] = 0x0
# alrm_ro1_pll1_lock_now[5:5] = 0x1
# alrm_ro1_pll1_acq_now[6:6] = 0x0
# alrm_ro1_pll1_nearlock_now[7:7] = 0x1
dut.write(0x7C, 0xAE)
...
# pll2_ro8_tunestatus[7:0] = 0xD
dut.write(0x8C, 0xD)

# pll2_ro8_vtune_error_lsb[7:0] = 0x1A
dut.write(0x8D, 0x1A)
...
# clkgrp1_div1_cfg12_divrat_lsb[7:0] = 0x18
dut.write(0xC9, 0x18)

# clkgrp1_div1_cfg12_divrat_msb[3:0] = 0x0
dut.write(0xCA, 0x0)

# clkgrp1_div1_cfg5_fine_delay[4:0] = 0x3
dut.write(0xCB, 0x3)
...
# clkgrp1_div2_cfg12_divrat_lsb[7:0] = 0x64
dut.write(0xD3, 0x64)
...
# clkgrp2_div1_cfg12_divrat_lsb[7:0] = 0x64
dut.write(0xDD, 0x64)
...
# clkgrp2_div1_cfg5_drvr_mode[4:3] = 0x3
...
# clkgrp2_div2_cfg12_divrat_lsb[7:0] = 0x18
dut.write(0xE7, 0x18)

# clkgrp2_div2_cfg12_divrat_msb[3:0] = 0x0
dut.write(0xE8, 0x0)

# clkgrp2_div2_cfg5_fine_delay[4:0] = 0x5
dut.write(0xE9, 0x5)
...
# clkgrp3_div1_cfg12_divrat_lsb[7:0] = 0x64
dut.write(0xF1, 0x64)
...
# clkgrp3_div1_cfg5_drvr_res[1:0] = 0x3
# clkgrp3_div1_cfg5_drvr_spare[2:2] = 0x0
# clkgrp3_div1_cfg5_drvr_mode[4:3] = 0x3
...
# clkgrp3_div2_cfg12_divrat_lsb[7:0] = 0x64
dut.write(0xFB, 0x64)
...
# clkgrp4_div1_cfg12_divrat_lsb[7:0] = 0x64
dut.write(0x105, 0x64)
...
dut.write(0x10E, 0xF1)

# clkgrp4_div2_cfg12_divrat_lsb[7:0] = 0x64
dut.write(0x10F, 0x64)
...
# clkgrp5_div1_cfg12_divrat_lsb[7:0] = 0x64
dut.write(0x119, 0x64)
...
# clkgrp5_div1_cfg5_drvr_res[1:0] = 0x3
...
dut.write(0x122, 0xF1)

# clkgrp5_div2_cfg12_divrat_lsb[7:0] = 0x69
dut.write(0x123, 0x69)
...
# clkgrp6_div1_cfg12_divrat_lsb[7:0] = 0x18
dut.write(0x12D, 0x18)

# clkgrp6_div1_cfg12_divrat_msb[3:0] = 0x0
dut.write(0x12E, 0x0)

# clkgrp6_div1_cfg5_fine_delay[4:0] = 0x5
dut.write(0x12F, 0x5)
...
dut.write(0x136, 0xF1)

# clkgrp6_div2_cfg12_divrat_lsb[7:0] = 0x64
dut.write(0x137, 0x64)
...
# clkgrp7_div1_cfg12_divrat_lsb[7:0] = 0x64
dut.write(0x141, 0x64)
...
dut.write(0x14A, 0xD1)

# clkgrp7_div2_cfg12_divrat_lsb[7:0] = 0x18
dut.write(0x14B, 0x18)

# clkgrp7_div2_cfg12_divrat_msb[3:0] = 0x0
dut.write(0x14C, 0x0)

# clkgrp7_div2_cfg5_fine_delay[4:0] = 0x5
dut.write(0x14D, 0x5)
